...
export function RentListings() {
  ...
  return (
    <div className="space-y-8 pb-20">
      {/* Header */}
      <motion.div
        className="relative isolate overflow-hidden rounded-[36px] bg-[linear-gradient(135deg,#111111_0%,#3a332d_55%,#8f7864_100%)] px-8 py-14 text-white shadow-2xl shadow-stone-900/10"
